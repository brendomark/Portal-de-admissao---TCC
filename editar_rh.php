...
<?php 
	...
	$sql = "SELECT 
				*,
				...
				F.DESCRICAO AS DES_FUNC,
				H.DESCRICAO AS DES_HR,
				pes.matricula as mt,
			...
			FROM 
				...
				INNER JOIN PPESSOA PES ON FUN.ID = PES.ID AND FUN.CODCOLIGADA = PES.CODCOLIGADA
				INNER JOIN PSECAO SEC ON SEC.CODCOLIGADA = FUN.CODCOLIGADA AND SEC.CODIGO = PES.CODSECAO
				INNER JOIN PFUNCAO F ON F.CODCOLIGADA = FUN.CODCOLIGADA AND F.CODIGO = PES.CODFUNCAO
				INNER JOIN AHORARIO H ON H.CODCOLIGADA = FUN.CODCOLIGADA AND H.CODIGO = PES.HORARIOS
	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<br>
				<a title="VOLTAR"href ="lista_func_rh.php" ><i class="fas fa-angle-double-left"></i></a>
					...
					<form method="post" action="update_rh.php" enctype="multipart/form-data">
						...
						<div class="row gtr-uniform">
							<div class="col-6 col-12-xsmall">
								<h5>Nome</h5>
								<input type="text" name="nome" id="nome" value="<?php echo $row_usuario['NOME'];?>" required/>
							</div>
							<div class="col-6 col-12-xsmall">
							...
							<div class="col-6 col-12-xsmall">
								<h5>Naturalidade</h5>	
								<input type="text" name="naturalidade" id="naturalidade" value="<?php echo $row_usuario['NATURALIDADE'];?>" placeholder="naturalidade" style="text-transform:uppercase;" required />
							</div>
							<div class="col-6 col-12-xsmall">
								<h5>Nacionalidade</h5>
							...
							<div class="col-4 col-12-xsmall">
								<h5>Número</h5>
								<input type="text" name="nmilitar" id="nmilitar" value="<?php echo $row_usuario['ALISTAMENTO'];?>" placeholder="Numero" />
							</div>
							<div class="col-4 col-12-xsmall">
								<h5>Categoria</h5>
								<input type="text" name="categoriamilitar" id="categoriamilitar" value="<?php echo $row_usuario['CATEGORIAMILITAR'];?>" placeholder="Categoria" />
							</div>
							<div class="col-4 col-12-xsmall">
								<h5>PIS</h5>
							...
							<div class="col-8 col-12-xsmall">
								<h5>Complemento</h5>
								<input type="text" name="complemento" id="complemento" value="<?php echo utf8_encode($row_usuario['COMPLEMENTO']);?>" placeholder="Complemento" style="text-transform:uppercase"/>
							</div>
							...
							<div id="dependentes" class="col-12">
							  ...
							  <?php while($dadosdep = mysqli_fetch_array($result_dep)):?> 
								...
								<a href = "delete_dep_rh.php?id=<?php echo $dadosdep['ID_DEP'];?>&ID_USER=<?php echo $row_usuario['ID'];?>&MATRICULA=<?php echo $row_usuario['MATRICULA'];?>">
							...
							<div class="col-4 col-12-xsmall">
								...
								<option value="<?php echo $row_usuario['CODFUNCAO'];?>"><?php echo utf8_encode($row_usuario['DES_FUNC']);?></option>

                                    ...
                                    <form method="post" action="cadastrouser.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row gtr-uniform">
                                            <div class="col-4 col-12-xsmall">
                                                <h5>Usuário</h5>
                                                <input type="text" name="usuario" id="usuario" value="" placeholder="Usuário" style="text-transform:uppercase;" required/>
                                            </div>
											<div class="col-4 col-12-xsmall">
                                                <h5>Primeiro Nome</h5>
                                                <input type="text" name="nomeusuario" id="nomeusuario" value="" placeholder="Primeiro Nome" style="text-transform:uppercase;" required/>
                                            </div>
                                            <div class="col-4 col-12-xsmall">
                                                <h5>CPF</h5>
                                                <input type="text" name="cpf" id="cpf" value="" placeholder="CPF" maxlength="11" onkeypress="$(this).mask('000.000.000-00');" style="text-transform:uppercase" required/>
                                            </div>
                                            
                                            <div class="col-4 col-12-xsmall">
                                                <h5>Senha</h5>
                                                <input type="password" name="password" id="password" value="" placeholder="Senha" style ="text-transform:uppercase"required />
                                            </div>
                                            <div class="col-4 col-12-xsmall">
                                                <h5>Email</h5>
											...
											<div class="col-4 col-12-xsmall">
                                                ...
                                                <input type="text" name="datalimite" id="datalimite" value="" placeholder="Data" onkeypress="$(this).mask('00/00/0000')" style = "text-transform:uppercase" required />
                                            </div>
